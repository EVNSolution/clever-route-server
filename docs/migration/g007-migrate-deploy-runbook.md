...
- The customer notification outbox migration is `20260723170000_add_customer_notification_outbox_worker`; it was the latest migration for the historical evidence below, not the current release cutoff.
...
The production monitor and rehearsal history validator do not delete or rewrite Prisma recovery history. A
