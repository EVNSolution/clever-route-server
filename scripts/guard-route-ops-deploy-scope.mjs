...
const allowedExact = new Set([
  ...
  'apps/delivery-api/src/modules/driver/driver.dependencies.ts',
  ...
  'apps/delivery-api/src/modules/driver/driver-route-session.repository.ts',
  'apps/delivery-api/src/modules/driver/driver-route-session.types.ts',
  'apps/delivery-api/src/modules/driver/driver-route-map-preview.renderer.ts',
  'apps/delivery-api/src/modules/driver/driver-route-map-preview.service.ts',
  ...
  'apps/delivery-api/src/modules/route-plans/route-optimization-job.types.ts',
  'apps/delivery-api/src/modules/route-plans/route-plan.dependencies.ts',
  ...
  'apps/delivery-api/src/routes/admin-ui-bulk-geocoding.ts',
  'apps/delivery-api/src/routes/admin-ui-commerce-settings.ts',
  'apps/delivery-api/src/routes/admin-ui-orders-sync.ts',
  'apps/delivery-api/src/routes/admin-ui-route-ops-api-response.ts',
  'apps/delivery-api/src/routes/admin-ui-route-planning.ts',
  'apps/delivery-api/src/routes/admin-ui-session-security.ts',
  'apps/delivery-api/src/routes/admin-ui-session.ts',
  'apps/delivery-api/src/routes/admin-ui-shell-rendering.ts',
  'apps/delivery-api/src/routes/driver-auth.routes.ts',
  'apps/delivery-api/src/routes/driver-events.routes.ts',
  'apps/delivery-api/tests/admin-commerce-auth.test.ts',
  ...
  'apps/delivery-api/tests/admin-ui-route-inventory.test.ts',
  'apps/delivery-api/tests/app-request-redaction.test.ts',
  ...
  'apps/delivery-api/tests/driver.dependencies.test.ts',
  ...
  'apps/delivery-api/tests/driver-route-session.repository.test.ts',
  'apps/delivery-api/tests/driver-route-session.routes.test.ts',
  'apps/delivery-api/tests/driver-route-map-preview.service.test.ts',
  ...
  'docs/deployment/route-ops-osrm-ontario.md',
  'docs/deployment/route-ops-vroom.md',
