...
checks = {
    ...
    'direct_wrapper_requires_migration_opt_in': 'RUN_MIGRATIONS=0' in shopify_command,
    'default_deploy_drops_migration_image': '6666666666666666666666666666666666666666666666666666666666666666' not in shopify_command,
    'default_deploy_drops_dsv_approval_data': all(value not in shopify_command for value in [
    ...
    'proof_media_s3_runtime': all(value in command for value in [
        ...
        'proof media S3 rollout blocked: approved HTTP scanner is not configured',
        'proof media S3 rollout blocked: approved scan monitor is not configured',
