...
describe('Route Ops driver invite and route assignment UI helpers', () => {
  ...
  test('RouteBuilder renders a full-width child sequence card with one aggregate Save route action', () => {
    ...
    expect(manifestHtml).toContain('route-child-manifest-detail-table');
    ...
    expect(manifestHtml).toContain('route-child-arrival-cell');
    expect(manifestHtml).toContain('Arrival');
    expect(manifestHtml).not.toContain('Dwell');
    expect(manifestHtml).not.toContain('12 min');
