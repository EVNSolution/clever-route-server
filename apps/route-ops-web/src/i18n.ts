...
export const routesCopy = {
  'en-CA': {
    ...
    routeOptimization: {
      ...
      running: 'Route Engine is optimizing this route. It can take several minutes; elapsed time alone is not a failure. The job times out only if the engine exceeds the configured result wait limit.',
  ...
  'ko-KR': {
    ...
    routeOptimization: {
      ...
      rerun: '최적화 다시 실행',
      running: 'Route Engine이 이 경로를 최적화 중입니다. 몇 분 걸릴 수 있으며, 시간이 지났다는 이유만으로 실패는 아닙니다. 엔진이 설정된 결과 대기 한도를 넘길 때만 시간 초과로 표시됩니다.',
