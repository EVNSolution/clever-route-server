...
export const routesCopy = {
  'en-CA': {
    ...
    stopTableTitle: 'Stop order table',
    stopTableHelp: 'Drag or use the arrow controls to preview the route order before saving.',
    saveRoute: 'Save route',
    savingRoute: 'Saving route…',
    routeSaveFullDraft: 'Save route applies driver, return option, and stop order together.',
    routeSavePendingChanges: 'Unsaved route changes are ready.',
  ...
  'ko-KR': {
    ...
    stopTableTitle: '하차 순서 테이블',
    stopTableHelp: '드래그하거나 화살표로 순서를 미리 본 뒤 저장하세요.',
    saveRoute: '경로 저장',
    savingRoute: '경로 저장 중…',
    routeSaveFullDraft: '경로 저장은 배송원, 복귀 옵션, 하차 순서를 한 번에 저장합니다.',
    routeSavePendingChanges: '저장되지 않은 경로 변경사항이 있습니다.',
