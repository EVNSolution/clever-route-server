...
export const driversCopy = {
  'en-CA': {
    ...
    installRoutesApp: 'Install CLEVER Routes',
  ...
  'ko-KR': {
    ...
    installRoutesApp: 'CLEVER Routes 앱 설치',
...
export const routesCopy = {
  'en-CA': {
    ...
    sendToDriverUnavailable: 'Assign a driver and add stops first.',
    sendingToDriver: 'Sending…',
    visibleToDriver: 'Visible to driver',
    ...
    routeItemTotal: 'Total',
    routeItemTypes: 'Types',
  ...
  'ko-KR': {
    ...
    publishRoute: '경로 게시',
    publishing: '게시 중…',
    sendToDriver: '배송원에게 보내기',
    sendToDriverUnavailable: '배송원을 배정하고 하차지를 추가하세요.',
    sendingToDriver: '전송 중…',
    visibleToDriver: '배송원에게 표시 중',
...
export const ordersCopy = {
  'en-CA': {
    ...
    addPlanAction: 'Add to Map',
    inventoryTitle: 'Inventory summary',
    inventoryPrint: 'Print inventory',
    inventoryEmpty: 'No item data for the current filters.',
    ...
    planOrderAction(action: 'Add' | 'Remove', label: string): string { return `${action} order ${label} ${action === 'Remove' ? 'from' : 'to'} map`; },
    ...
    customerOrderNoteEmpty: 'No customer note on this order.',
    customerAdminMemo: 'Admin memo',
    customerAdminMemoHint: 'Private operator note for this delivery customer. Saving overwrites the current memo.',
    customerAdminMemoPlaceholder: 'Add a memo for future orders to this customer…',
    customerAdminMemoUnavailable: 'Customer memo is not available for this order yet.',
    saveMemo: 'Save memo',
  ...
  'ko-KR': {
    ...
    addPlanAction: '지도에 추가',
    inventoryTitle: '품목 요약',
    inventoryPrint: '품목표 인쇄',
    inventoryEmpty: '현재 필터의 품목 데이터가 없습니다.',
    inventoryOrders: '주문',
    orders: '주문',
    routeDate: '경로 날짜',
    routeName: '경로 이름',
    ...
    planOrderAction(action: 'Add' | 'Remove', label: string): string { return action === 'Remove' ? `${label} 주문을 지도에서 제거` : `${label} 주문을 지도에 추가`; },
    ...
    saveFixes: '수정 저장',
    destination: '배송지',
    customerOrderNote: '고객 주문 메모',
    customerOrderNoteEmpty: '이 주문에 고객 메모가 없습니다.',
    customerAdminMemo: '관리자 메모',
    customerAdminMemoHint: '배송 고객 기준 내부 메모입니다. 저장하면 현재 메모를 덮어씁니다.',
    customerAdminMemoPlaceholder: '이 고객의 다음 주문에 참고할 메모를 입력하세요…',
    customerAdminMemoUnavailable: '이 주문에서는 아직 고객 메모를 사용할 수 없습니다.',
    saveMemo: '메모 저장',
    memoSaved: '메모 저장됨.',
    coordinates: '좌표',
    delivery: '배송',
...
export const settingsCopy = {
  'en-CA': {
    ...
    deliveryDefaultsTitle: 'Stop timing defaults',
    deliveryDefaultsDescription: 'Operational timing and trigger rules used by Route Ops.',
    destinationDwellMinutes: 'Stop dwell minutes',
    nearbyStopsThreshold: 'Nearby stop threshold',
    emailEyebrow: 'Email',
    ...
    editEmailTemplate: 'Edit template',
    templateSummary: 'Template editing opens separately. Changes are saved only by Save settings.',
    templateSubjectPreview: 'Subject',
    templateBodyPreview: 'Body preview',
    templateModalTitle: 'Edit email template',
    templateModalDescription: 'Update the draft template here, then use Save settings at the bottom of Settings to persist changes.',
    templateDone: 'Done',
  ...
  'ko-KR': {
    ...
    deliveryDefaultsTitle: '배송지 체류 기본값',
    deliveryDefaultsDescription: 'Route Ops에서 사용하는 운영 타이밍과 트리거 규칙입니다.',
    destinationDwellMinutes: '배송지 체류 시간(분)',
    nearbyStopsThreshold: '근접 정류지 기준',
    emailEyebrow: '이메일',
    ...
    editEmailTemplate: '템플릿 편집',
    templateSummary: '템플릿 편집은 별도로 열립니다. 변경 내용은 하단 설정 저장으로만 저장됩니다.',
    templateSubjectPreview: '제목',
    templateBodyPreview: '본문 미리보기',
    templateModalTitle: '이메일 템플릿 편집',
    templateModalDescription: '여기에서 템플릿 초안을 수정한 뒤, 설정 하단의 저장 버튼으로 저장하세요.',
    templateDone: '완료',
    templateSubject: '제목',
    templateBody: '본문',
