...
describe('G005 DSV v1 read DTO adapter', () => {
  ...
  test('maps seller order summaries and page info from supplied route-stop ETA only', () => {
    const dto = mapDsvV1SellerOrderSummary({
      ...
      latestDriverMessage: {
        ...
        readByDriverAt: new Date('2026-07-23T01:05:00.000Z'),
      },
    ...
    expect(dto).toEqual({
      ...
      latestDriverMessage: {
        ...
        messageId: 'driver-message-1',
        readByDriverAt: '2026-07-23T01:05:00.000Z',
      },
      longitude: 127.1234567,
      routePlanId: 'route-plan-1',
      routeStopSequence: 4,
    ...
    const list = mapDsvV1ManagementListPage({
      items: [
        ...
        mapDsvV1DestinationListItem({
          ...
          displayName: 'Dock A',
          memo: '후문 이용',
          memoUpdatedAt: new Date('2026-09-07T01:00:00.000Z'),
          openTime: '08:30',
          openTimeUpdatedAt: new Date('2026-09-07T01:00:00.000Z'),
          postalCode: '06236',
        }),
        mapDsvV1ConditionListItem({
          code: 'COLD',
    ...
    expect(list).toEqual({
      items: [
        ...
        { customerId: 'customer-1', displayName: 'Customer A', externalCustomerCode: 'C-1', orderCount: 4 },
        {
          ...
          displayName: 'Dock A',
          memo: '후문 이용',
          memoUpdatedAt: '2026-09-07T01:00:00.000Z',
          openTime: '08:30',
          openTimeUpdatedAt: '2026-09-07T01:00:00.000Z',
          postalCode: '06236',
        },
        {
          code: 'COLD',
  ...
  test('emits only customer-owned delivery location and assigned vehicle context', () => {
    ...
    expect(dto).not.toHaveProperty('latestDriverMessage');
