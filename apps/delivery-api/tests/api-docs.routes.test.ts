...
describe('API documentation routes', () => {
  ...
  test('GET /docs/openapi.yaml documents the complete served DSV v1 runtime boundary', async () => {
    ...
    try {
      ...
      expect(implementedRoutes).toEqual([
        ...
        { method: 'get', path: '/api/dsv/v1/customer/seller-orders/:sellerOrderId/messages' },
        ...
        { method: 'post', path: '/api/dsv/v1/seller-orders/:sellerOrderId/active-removal/request' },
        ...
        { method: 'post', path: '/api/dsv/v1/seller-orders/:sellerOrderId/messages' },
        { method: 'post', path: '/api/dsv/v1/seller-orders/:sellerOrderId/recover-unassigned' },
  ...
  test('GET /docs/openapi.yaml documents destination-grouped customer delivery fields without relaxing strict items', async () => {
    ...
    try {
      ...
      expect(customerDeliveryPage).toContain('customerDisplayName:\n          type: string');
      expect(customerDeliveryPage).toContain('departureLocation:');
...
function expectedAdminAppFacingRoutes(): RouteMethodPair[] {
  const routes: RouteMethodPair[] = [
    ...
    { method: 'post', path: '/admin/route-groups/:routeGroupId/stops/custom' },
    { method: 'delete', path: '/admin/route-groups/:routeGroupId/stops/:deliveryStopId/custom' },
    { method: 'patch', path: '/admin/route-groups/:routeGroupId/stops/:deliveryStopId/custom' },
