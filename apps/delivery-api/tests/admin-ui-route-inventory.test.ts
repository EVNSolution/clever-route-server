...
const expectedRouteRegistrations: RouteRegistration[] = [
  ...
  { line: 450, method: "GET", pathExpression: "ROUTES_APP_DOWNLOAD_PATH" },
  { line: 450, method: "GET", pathExpression: "LEGACY_DRIVER_APP_INSTALL_PATH" },
  { line: 461, method: "GET", pathExpression: "ROUTES_APP_ANDROID_RELEASE_PATH" },
  { line: 461, method: "GET", pathExpression: "LEGACY_DRIVER_APP_ANDROID_RELEASE_PATH" },
  ...
  { line: 0, method: "GET", pathExpression: "`${ADMIN_UI_APP_API_PATH}/routes/:routePlanId/operational-state`" },
  { line: 1309, method: "GET", pathExpression: "`${ADMIN_UI_APP_API_PATH}/notifications/stream`" },
  { line: 1309, method: "PATCH", pathExpression: "`${ADMIN_UI_APP_API_PATH}/notifications/:notificationId/read`" },
  { line: 0, method: "PATCH", pathExpression: "`${ADMIN_UI_APP_API_PATH}/notifications/:notificationId/acknowledge`" },
  ...
  { line: 1956, method: "POST", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups`" },
  { line: 1957, method: "DELETE", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId`" },
  { line: 1958, method: "GET", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId`" },
  { line: 1958, method: "PATCH", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId/polygons`" },
  { line: 1959, method: "PATCH", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId/assignments`" },
  { line: 1960, method: "POST", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId/generate-child-routes`" },
  { line: 1961, method: "POST", pathExpression: "`${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId/rollback`" },
...
describe("admin UI route inventory", () => {
  ...
  test("keeps the high-risk mutation and security boundaries represented", () => {
    ...
    expect(registrations).toContain("GET `${ADMIN_UI_APP_API_PATH}/notifications/stream`");
    ...
    expect(registrations).toContain("POST `${ADMIN_UI_APP_API_PATH}/route-groups`");
    expect(registrations).toContain("DELETE `${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId`");
    expect(registrations).toContain("PATCH `${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId/polygons`");
    expect(registrations).toContain("POST `${ADMIN_UI_APP_API_PATH}/route-groups/:routeGroupId/generate-child-routes`");
    ...
    expect(expectedRouteRegistrations).toHaveLength(112);
  });
});
