...
| DSV operator web | `/api/dsv/resources`, `/api/dsv/drivers*`, `/api/dsv/vehicles*`, `/api/dsv/conditions`, `/api/dsv/manual-email`, `/api/dsv/dispatch-imports*`, `/api/dsv/control*`, `/api/dsv/v1/*` | Shop-scoped DSV session cookie and CSRF on writes | `dsv-resource-management.md`, `dsv-dispatch-import.md`, `dsv-map-profile.md` |
...
| Native driver app | `/driver/auth/*`, `/driver/route-access/lookup`, `/driver/consents`, `/driver/assigned-route`, `/driver/delivery-space*`, `/driver/orders/*`, `/driver/proof-media*`, `/driver/events` | Invite + PIN registration, then phone + PIN login and short-lived server-issued JWTs | `driver-auth.md`, `driver-route-access.md`, `driver-consents.md`, `driver-assigned-route.md`, `driver-delivery-space.md`, `driver-seller-order-assignment.md`, `driver-proof-media.md` |
