...
export type DriverSellerOrderAssignmentServiceContract = {
  acquire(input: DriverRouteAccessScope & { orderId: string }): Promise<DriverSellerOrderAssignmentResult>;
  listUnassigned(input: DriverRouteAccessScope): Promise<DriverSellerOrder[]>;
  release(input: DriverRouteAccessScope & { orderId: string }): Promise<DriverSellerOrderAssignmentResult>;
};
...
export class DriverSellerOrderAssignmentService implements DriverSellerOrderAssignmentServiceContract {
  ...
  async acquire(input: DriverRouteAccessScope & { orderId: string }): Promise<DriverSellerOrderAssignmentResult> {
  ...
  async release(input: DriverRouteAccessScope & { orderId: string }): Promise<DriverSellerOrderAssignmentResult> {
    const { grouping } = await this.loadScopedGrouping(input);
