...
ALTER TYPE "DsvPrincipalType" ADD VALUE IF NOT EXISTS 'IMPORT_WORKER';
ALTER TYPE "DsvPrincipalType" ADD VALUE IF NOT EXISTS 'DEVICE';
ALTER TYPE "DsvPrincipalType" ADD VALUE IF NOT EXISTS 'SYSTEM_WORKER';
